...
# Fraction 精确，无浮点
recommend_merkle_deployment_weighted_scenarios(
    4, (None, None, None, 9000), ((1, 1, 1, 1), (0, 0, 0, 1))
)
# MerkleStorageProfile(w=4, height=2, ...)
