...
class AdvanceAndMultiproofMerkleAuthStateTest(unittest.TestCase):
    ...
    def test_proof_matches_advance_to_sign_batch_then_multiproof_encode(self):
    ...
    def test_equal_target_is_legal_and_proves_current_leaves(self):
        signer = make_signer(height=3)
        signer.advance_to(3)
    ...
    def test_generation_endpoints(self):
        ...
        _, _, envelope, generation = advance_and_multiproof_merkle_auth_state(
