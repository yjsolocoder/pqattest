...
class OneTimeSigner:
    ...
    def sign_with_auth_state(
        ...
        message rules, same Lamport signature and the same post-sign
        ...
        can succeed, and no randomness is drawn. The envelope is plaintext
        and authenticated only; it provides neither encryption nor
