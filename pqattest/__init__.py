...
recommend_merkle_mode_weighted_scenarios to rank that same per-group mode
frontier by the smallest worst-case regret over a non-empty tuple of
five-weight scenarios with exact Fraction arithmetic, MerkleVerifyProfile / merkle_verify_profile,
