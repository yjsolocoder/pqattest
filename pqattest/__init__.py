...
multiproof_verify_bound (MerkleProof.verify_bound,
MerkleBatchProof.verify_bound and multiproof_verify_bound bind a proof, batch
or multiproof to the receiver's expected public key and, optionally, an
explicit leaf-index selection), static
