...
class RecommendMerkleVerifyModeDeploymentTest(unittest.TestCase):
    ...
    def test_matches_brute_force_ranking(self):
        workloads = (
            ...
            (16, _GROUPS, (None, 5000, 12000, None, 8, None)),
            (8, ((0,), (1, 2), (4, 7)), (None, None, None, None, None, 10**18)),
            (4, ((3,),), (None, 4000, None, None, None, None)),
            (4, ((0, 1), (2, 3)), (9000, None, 7000, None, 4, None)),
            (2, ((0,), (1,)), (None, None, None, None, None, 6000)),
            (32, ((0,), (1, 7), (16, 31)), (None, None, None, None, 50, None)),
        )
    ...
    def test_verify_minimises_hashes_then_steps(self):
        ...
        groups = ((0,), (1, 2), (4, 7))
        frontier = merkle_verify_mode_frontier(8, groups, budgets)
        result = recommend_merkle_verify_mode_deployment(
            8, groups, budgets, prefer="verify"
        )
    ...
    def test_different_preferences_can_disagree(self):
        ...
        compact = recommend_merkle_verify_mode_deployment(
            8, groups, budgets, prefer="compact"
        )
    ...
    def test_budgets_are_honoured(self):
        ...
        for prefer in _PREFERS:
            result = recommend_merkle_verify_mode_deployment(
                4, groups, budgets, prefer=prefer
            )
    ...
    def test_invalid_arguments_match_frontier(self):
        ...
        # a member group that is not itself a tuple raises TypeError
        with self.assertRaises(TypeError):
            recommend_merkle_verify_mode_deployment(16, ((0, 1), [3, 5]), _BUDGETS)
        # illegal group contents raise ValueError
        with self.assertRaises(ValueError):
            recommend_merkle_verify_mode_deployment(16, ((),), _BUDGETS)
        with self.assertRaises(ValueError):
            recommend_merkle_verify_mode_deployment(16, ((1, 0),), _BUDGETS)
        with self.assertRaises(ValueError):
            recommend_merkle_verify_mode_deployment(16, ((0, 0),), _BUDGETS)
        ...
        with self.assertRaises(ValueError):
            recommend_merkle_verify_mode_deployment(
                16, _GROUPS, (0, None, None, None, None, None)
            )
        with self.assertRaises(ValueError):
            recommend_merkle_verify_mode_deployment(
                16, _GROUPS, (True, None, None, None, None, None)
            )
    ...
    def test_arguments_validated_like_frontier_before_prefer(self):
        ...
        # screened there before prefer is examined
        with self.assertRaises(ValueError):
            recommend_merkle_verify_mode_deployment(
    ...
    def test_pure_no_state_change(self):
        ...
        for prefer in _PREFERS:
            first = recommend_merkle_verify_mode_deployment(
                4, ((0, 1), (2, 3)), (None, None, None, 9000, None, None),
                prefer=prefer,
            )
