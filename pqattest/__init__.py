...
explain_merkle_mode_weighted to export that single-weight mode ranking's
decision-cost breakdown as a tuple of frozen MerkleModeScore rows — one per
frontier member, in frontier order, each carrying the candidate's workload
plan, its five normalised costs, its final score and a selected flag —
